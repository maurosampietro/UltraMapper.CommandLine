...
The above example also shows a few features:
   ...
   - The basic syntax:        
       ...
       This is not all about syntax. [Read more about the syntax here](https://github.com/maurosampietro/UltraMapper.CommandLine/wiki/Default-syntax)     
   ...
   - The Option attribute:        
       ...
       This is not all about the option attribute. [Read more about the Option attribute here](https://github.com/maurosampietro/UltraMapper.CommandLine/wiki/OptionAttribute)     
